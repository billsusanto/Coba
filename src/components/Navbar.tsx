...
export default function Navbar() {
  ...
  return (
    <nav
      className={`bg-transparent fixed top-0 z-50 w-full transition-transform duration-300 ${
      ...
      <div className="w-100%">
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center space-x-10 pr-5">
            <Link
              href="/login"
              className="text-gray-700 border-2 border-gray-600 rounded-xl px-4 py-2 sm:w-20 md:w-40 text-center text-xl"
            >
              Login
            </Link>
            <Link
