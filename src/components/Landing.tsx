    ...
    <div>
        ...
        <div className="flex flex-col items-center bg-white">
            <div className='w-full h-two-third-screen flex items-center justify-center'>
                ...
                <p className="mt-2 text-4xl text-gray-600 mb-5">Collaborate through projects</p>
            ...
            <div className={`pt-10 w-full min-h-half-screen bg-gradient-to-b from-white via-customBlue-light to-white flex flex-col items-center pb-20 transition-all duration-1000 ${fadeIn ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <div className="flex justify-around text-center w-1/2 pb-10">
                    <div className="flex flex-col items-center mr-20">
                        ...
                        <div className="mt-2 w-full">
                            <div className={`h-1 ${hoveredTab === 'Create' ? 'bg-gradient-to-r from-customBlue-default to-customBlue-dark animate-drawLine' : 'invisible'}`}></div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col items-center mr-20">
                        ...
                        <div className="mt-2 w-full">
                            <div className={`h-1 ${hoveredTab === 'Connect' ? 'bg-gradient-to-r from-customBlue-default to-customBlue-dark animate-drawLine' : 'invisible'}`}></div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <div className="mt-2 w-full">
                            <div className={`h-1 ${hoveredTab === 'Collaborate' ? 'bg-gradient-to-r from-customBlue-default to-customBlue-dark animate-drawLine' : 'invisible'}`}></div>
                        </div>
                    </div>
                </div>
