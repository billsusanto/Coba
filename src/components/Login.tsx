    ...
    <div className="flex min-h-screen">
      <div className="flex flex-1 items-center justify-center">
        <div className="w-full max-w-md space-y-8">
          <div>
            <h2 className="mt-6 text-center text-5xl font-semibold text-maroon-default">Log in</h2>
          </div>
          <form className="mt-8 space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="text-sm">
                <Link href="#" className="font-medium text-transparent bg-clip-text bg-gradient-to-r from-maroon-default to-maroon-dark text-lg">
