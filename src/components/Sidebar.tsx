          ...
          <>
            <Link href="/my-profile">
                <div className="flex items-center text-white text-xl mb-10 w-full">
                    <Image src="/default-avatar.png" alt="User Avatar" width={32} height={32} className="w-12 h-12 rounded-full mr-3"/>
                ...
                <button
                    ...
                    >
                    <Image src='/Logout.png' alt="Logout" width={6} height={6} className="w-6 h-6 mr-4"/>
                    Logout
                </button>
            </Link>
          </>
