    ...
    <div>
      ...
      <div className="flex flex-col items-center h-one-third-screen bg-gradient-to-b from-white via-indigo-100 to-white">
        <header className="text-center mt-20">
          <h1 className="text-7xl font-semibold text-black mb-5 mt-10">
            Coba.
          </h1>
            ...
            <div className="bg-white rounded-lg shadow-lg p-5 relative">
              <div className="flex">
                ...
                <div className="ml-5">
                  ...
                  <p className="mt-2">
                    <span className="font-semibold">Creator:</span> Bad Ape
                  </p>
                  ...
                  <p className="mt-2">
                    <span className="font-semibold">Positions:</span> Front-End
                    Developer, Head of Marketing, +2 more
                  </p>
                </div>
              </div>
              <div className="flex items-center justify-between mt-5">
                ...
                <Link
                  href="#"
                  className="bg-gradient-to-r from-blue-400 to-indigo-600 text-white rounded-md px-4 py-2"
                >
                  Collaborate
                </Link>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-5 relative">
              <div className="flex">
                ...
                <div className="ml-5">
                  ...
                  <p className="mt-2">
                    <span className="font-semibold">Creator:</span> Ceasar
                  </p>
                  <div className="flex items-center mt-2">
                    <Image
                      src=""
