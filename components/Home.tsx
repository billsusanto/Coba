  ...
  return (
    <div>
        ...
        <div className="container mx-auto">
          <div className="flex justify-around text-gray-600 mb-10">
            <div 
              onMouseEnter={() => handleMouseEnter('Computer Science')} 
              onMouseLeave={handleMouseLeave}
            >
                <p className={`text-2xl text-black ${hoveredTab ? 'text-transparent bg-clip-text bg-gradient-to-r from-customBlue-default to-indigo-600' : ''}`}>Computer Science</p>
                <div className="mt-2 w-full">
                    <div className={`h-1 ${hoveredTab ? 'bg-gradient-to-r from-customBlue-default to-indigo-600 animate-drawLine' : 'invisible'}`}></div>
                </div>
            </div>
            <div 
              ...
              onMouseLeave={handleMouseLeave}
            >
                <p className={`text-2xl text-black ${hoveredTab ? 'text-transparent bg-clip-text bg-gradient-to-r from-customBlue-default to-indigo-600' : ''}`}>Business</p>
                <div className="mt-2 w-full">
                    <div className={`h-1 ${hoveredTab ? 'bg-gradient-to-r from-customBlue-default to-indigo-600 animate-drawLine' : 'invisible'}`}></div>
                </div>
            </div>
            <div 
              ...
              onMouseLeave={handleMouseLeave}
            >
                <p className={`text-2xl text-black ${hoveredTab ? 'text-transparent bg-clip-text bg-gradient-to-r from-customBlue-default to-indigo-600' : ''}`}>Arts</p>
                <div className="mt-2 w-full">
                    <div className={`h-1 ${hoveredTab ? 'bg-gradient-to-r from-customBlue-default to-indigo-600 animate-drawLine' : 'invisible'}`}></div>
                </div>
            </div>
            <div 
              ...
              onMouseLeave={handleMouseLeave}
            >
                <p className={`text-2xl text-black ${hoveredTab ? 'text-transparent bg-clip-text bg-gradient-to-r from-customBlue-default to-indigo-600' : ''}`}>Engineering</p>
                <div className="mt-2 w-full">
                    <div className={`h-1 ${hoveredTab ? 'bg-gradient-to-r from-customBlue-default to-indigo-600 animate-drawLine' : 'invisible'}`}></div>
                </div>
            </div>
